-- ============================================================================
-- REBUILD player_cumulative_points WITH FIXED DRAFT AND LEAGUE POINTS
-- ============================================================================
-- This script rebuilds the player_cumulative_points table with corrected
-- F13 (league points) and F17 (draft points) from the fixed source tables
-- ============================================================================
...
-- F13: League Points - JOIN WITH FIXED DL_F13_league_points
f13_data AS (
  SELECT
    ps.id AS player_id,
...
-- F14: Team Points - FROM DL_F14_team_points
f14_data AS (
  SELECT
    ps.id AS player_id,
...
f15_data AS (
  SELECT
    ...
    total_international_points AS f15_international_points
