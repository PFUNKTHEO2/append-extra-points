...
TEAM_ALIASES = {
    ...
    'the hotchkiss school': 'hotchkiss-school',
    'hotchkiss school': 'hotchkiss-school',
    'canterbury': 'canterbury-school',
    'canterbury school': 'canterbury-school',
    ...
    'pomfret school': 'pomfret-school',
    'gunnery': 'the-gunnery',
    'the gunnery': 'the-gunnery',
    ...
    'northampton': 'williston-northampton',
    'cushing': 'cushing-academy',
    'cushing academy': 'cushing-academy',
    'exeter': 'phillips-exeter',
    'phillips exeter': 'phillips-exeter',
    'andover': 'phillips-andover',
    'phillips andover': 'phillips-andover',
    'nobles': 'noble-greenough',
    'noble': 'noble-greenough',
    'noble greenough': 'noble-greenough',
    'noble and greenough': 'noble-greenough',
    ...
    'middlesex school': 'middlesex-school',
    ...
    'winchendon school': 'winchendon-school',
    ...
    'brunswick school': 'brunswick-school',
    'st lukes': 'st-lukes',
    "st luke's": 'st-lukes',
    "st. luke's": 'st-lukes',
...
def find_game_in_schedule(game_date, away_team_id, home_team_id):
    ...
    WHERE game_date = '{game_date}'
      AND (
        ...
        OR (away_team_id LIKE '%{away_team_id}%' AND home_team_id LIKE '%{home_team_id}%')
        OR (away_team_id LIKE '%{away_team_id.replace("-", "%")}%' AND home_team_id LIKE '%{home_team_id.replace("-", "%")}%')
      )
    LIMIT 1
    """
